 ...
 * @author Admin
 */
public class guiRegier extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guiRegier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
